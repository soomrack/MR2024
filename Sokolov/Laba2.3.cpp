...
public:
    airport() : index(0), name() {}
    airport(int index, const std::string& name) : index(index), name(name) {}
    ...
    bool operator==(const airport& other) const { return index == other.index; }
...
public:
    ...
    const airport& get_origin() const { return origin; }
    const airport& get_destination() const { return destination; }
    time_t get_departure_time() const { return departure_time; }
    time_t get_total_time() const { return total_time; }
    time_t get_flight_time() const { return flight_time; }
