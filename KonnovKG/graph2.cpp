...
void Airport::add_airport(const std::string& code, const std::string& name) {
    airport_names[code] = name;
}

std::string Airport::get_airport_name(const std::string& code) const {
...
std::pair<Path, double> FlightGraph::dijkstra(const std::string& start, const std::string& end) {
